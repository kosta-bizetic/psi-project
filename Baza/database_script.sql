...
INSERT INTO `psigram`.`User` (`id_user`, `username`, `password`, `name`, `surname`, `email`, `date_of_birth`, `gender`, `type`, `profile_picture_path`) VALUES (DEFAULT, 's', 's', 'Standard', 'Standardic', 'ldojcilovic@gmail.com', '1997-11-12', 'm', 's', NULL);
INSERT INTO `psigram`.`User` (`id_user`, `username`, `password`, `name`, `surname`, `email`, `date_of_birth`, `gender`, `type`, `profile_picture_path`) VALUES (DEFAULT, 'b', 'b', 'Business', 'Businessic', 'bk160121d@student.etf.bg.ac.rs', '1997-12-10', 'm', 'b', NULL);
...
START TRANSACTION;
USE `psigram`;
INSERT INTO `psigram`.`Post` (`id_post`, `timestamp`, `image_name`, `sponsored`, `id_user`, `num_likes`) VALUES (1, '2019-05-30 18:24:26', 'u_1559233466.jpg', 0, 2, DEFAULT);
INSERT INTO `psigram`.`Post` (`id_post`, `timestamp`, `image_name`, `sponsored`, `id_user`, `num_likes`) VALUES (2, '2019-05-30 18:24:32', 'u_1559233472.jpg', 0, 2, DEFAULT);
