...
START TRANSACTION;
USE `psigram`;
INSERT INTO `psigram`.`Post` (`id_post`, `timestamp`, `image_name`, `sponsored`, `id_user`) VALUES (1, '2019-05-30 18:24:26', 'u_1559233466', 0, 2);
INSERT INTO `psigram`.`Post` (`id_post`, `timestamp`, `image_name`, `sponsored`, `id_user`) VALUES (2, '2019-05-30 18:24:32', 'u_1559233472', 0, 2);
